...
<div class="wrapper">
	...
	<div class="container">
		...
		<form name="registerForm" class="form" action="{{ route('registerPost') }}" method="post">
			<input id="usrname" name="username" type="text" placeholder="用户名">
			<input id="email" name="email" type="text" placeholder="E-mail">
			<input id="pwd" name="password" type="password" placeholder="密码">
			<input id="cpwd" name="confirmPassword" type="password" placeholder="确认密码">
			<input id="port_pwd" name="port_password" type="text" placeholder="端口密码">
			<input id="code" name="code" type="text" placeholder="邀请码">

			<button type="submit" id="submit_btn">注册</button>
		</form>
	</div>
