                                                ...
                                                <div class="form-body pal">
                                                    ...
                                                    <div class="form-group">
                                                        <div class="input-icon right">
                                                            ...
                                                            <input id="usrname" name="usrname" type="text" placeholder="Username" class="form-control" /></div>
                                                    </div>
                                                    <div class="form-group">
                                                        <div class="input-icon right">
                                                            <i class="fa fa-lock"></i>
                                                            <input id="usr_password" name="usr_password" type="password" placeholder="Password" class="form-control" /></div>
                                                    </div>
                                                    <div class="form-group">
                                                        <div class="input-icon right">
                                                            <i class="fa fa-lock"></i>
                                                            <input id="confirmPassword" name="confirmPassword" type="password" placeholder="Confirm Password" class="form-control" /></div>
                                                    </div>
                                                    <hr />
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                <input id="port" name="port" type="text" placeholder="端口号：1024~65535" class="form-control" /></div>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                <input id="port_password" name="port_password" type="text" placeholder="端口密码" class="form-control" /></div>
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                      <p>加密</p>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                              <p>协议参数</p>
                                                                <input id="protocol_param" name="protocol_param" type="text" placeholder="此参数复杂，建议不填或填null" class="form-control" /></div>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                              <p>混淆参数</p>
                                                                <input id="obfs_param" name="obfs_param" type="text" placeholder="例如：example.com" class="form-control" /></div>
                                                        </div>
                                                    </div>
