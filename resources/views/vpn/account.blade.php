                  ...
                  <div id="generalTabContent" class="tab-content responsive">
                    <div id="alert-tab" class="tab-pane fade in active">
                        <div class="row">
                            ...
                            <div class="col-lg-6"><h3>SSR独享额外配置</h3>
                        ...
                        <div class="row">
                          <div class="col-lg-6"><h3>二维码一键配置</h3>
                            <div id="btn" class="alert alert-success alert-dismissable">
                                <h5><strong id="tip_text"></br>点击此处展开二维码</br></strong></h5>
                                <div id="qrcodeCanvas" style="display:none"></div>
                            </div>
                        </div>
                        <div class="col-lg-6"><h3>SS/SSR软件推荐</h3>
                          <div class="alert alert-danger alert-dismissable">
                              ...
                              <strong>Windows: </strong><a href="https://downloads.jiacyer.com/ShadowsocksR.zip">ShadowSocksR</a>
                          </div>
                        </div>
                      </div>
                    </div>
